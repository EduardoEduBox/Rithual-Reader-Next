...
# Why Rithual Reader is the best fit for this project!
...
- What is the project about?
  #### ​a manga reader that provides you a much cleaner and optimized way to read the manga (૨¡Ƭષαℓ (Rithual)
- What is the goal of the project?
  #### for the user to have the best experience and immersion reading Rithual
- What is the target user?
  #### young geek people
- Is there any existing project that you can use as a reference?
  #### yes, [Mangá livre, Tapas.io and Webtoons]
...
- Any other idea that you can think of
  ...
  #### Rithual Reader has the perfect complexity for 1 person
...
##### NEXT.JS, FIREBASE AUTH, FIRESTORE DB, TAILWIND CSS, AXIOS (requests), TYPESCRIPT ​
...
- Entities are nouns. Identify the nouns in your user stories.
  - Example:
    As a **user**,
    I want to be able to search for a specific **chapter**
...
- Merge conflicts happens. There are ways of minimizing them but you can neve get rid of them completely.
  #### i will not have much problems with it, just if i need help of someone and we work togheter on the same thing, so yes, in this case we would have github conflicts
